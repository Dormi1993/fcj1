		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case SendDataToServer.SEND_SUCCESS:
					Toast.makeText(TransmissionActivity.this, "登陆成功", Toast.LENGTH_SHORT).show();
					break;
				case SendDataToServer.SEND_FAIL:
					Toast.makeText(TransmissionActivity.this, "登陆失败", Toast.LENGTH_SHORT).show();
					break;
		...
		btnSend.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(name)||pwd.equals("")) {
					Toast.makeText(TransmissionActivity.this, "用户名或密码不能为空", Toast.LENGTH_LONG).show();
				}else {
